...
output:
  html_document:
    theme: yeti
pagetitle: "Current Research | Freshwater Fish Ecology Lab"
---
...
**Dr. Jeff Falke (PI)** <br>
**Brooke Radow (MS Student; NRES)** <br>
**Tanner Morgan (Undergraduate Researcher; NRES)**

**Funding: University of Nevada, Reno; Nevada Department of Wildlife**

<img src="images/IMG_5397.jpeg" style="width:40%; border:2px solid; margin-left: 15px" align="right">
...
### **Connecting Streams and Landscapes: Drivers and Characteristics of Aquatic–Terrestrial Subsidies in the Great Basin**

<br>
[**Project Personnel**]{.ul}<br>
**Dr. Jeff Falke (PI)** <br>
**Christopher Frazier (PhD Student; EECB)**

**Funding: U.S. Geological Survey, Ecosystems Mission Area**

<img src="images/wall_bugs.jpg" style="width:30%; border:2px solid; margin-right: 15px" align="left">

The Great Basin is extremely arid, which means both that surface waters are scarce and that terrestrial productivity is low. In other arid systems, low terrestrial productivity makes the subsidies streams provide disproportionately important to terrestrial consumers, so understanding these subsidies is a regional priority. Yet the literature on Great Basin stream macroinvertebrates is sparse, and work on aquatic–terrestrial subsidies is effectively absent. In this study, we will synthesize existing macroinvertebrate community data from state, federal, and academic datasets to build the first comprehensive, region-wide database of stream invertebrate composition. Community composition is central to understanding the subsidies these systems provide, but so is knowing how hydrological regime and non-native species shape subsidy characteristics, including subsidy magnitude, timing, and footprint on the surrounding landscape. To that end, we will compare subsidies in habitats with and without historically stocked Brown Trout, and measure subsidy magnitude and terrestrial footprint in streams spanning a gradient from perennial to non-perennial flow. Combining these datasets, we will generate basin-wide estimates of aquatic–terrestrial subsidy magnitude and footprint to determine how much terrestrial habitat in the region is directly subsidized by aquatic systems. This project is a collaborative effort between researchers at the **U.S. Geological Survey** and the **Nevada Cooperative Fish and Wildlife Research Unit at University of Nevada, Reno**.
...
[**Project Personnel**]{.ul}<br>
**Dr. Jeff Falke (PI)** <br>
**Eddy Kapp (MS Student; NRES)**

**Funding: Nevada Department of Wildlife**

<img src="images/WCS_mountain.jpg" style="width:20%; border:2px solid; margin-right: 15px" align="right">
...
<img src="images/y_k-map.jpg" style="width:30%; border:2px solid; margin-right: 15px" align="left">
