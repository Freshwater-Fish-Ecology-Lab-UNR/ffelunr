...
output:
  html_document:
    theme: yeti
pagetitle: "Past Projects | Freshwater Fish Ecology Lab"
---
...
<br>
<div class="expand collapsed" data-toggle="collapse" data-target="#spinedace" aria-expanded="false" aria-controls="spinedace">
<div style="background-color:rgba(0, 0, 0, 0.0470588); padding:0px 12px;">
<a style="color:black">
<font size="4"> **Habitat Suitability for Big Spring Spinedace (Lepidomeda mollispinis pratensis) in Meadow Valley Wash, Nevada (2024 - 2026)** </font>
</a>
</div>

<div class="collapse" id="spinedace">
<hr>
PI: **Dr. Jeff Falke**

Staff: **Mark Kolwyck** (Staff Scientist 2024-2026)

Funding: U.S. Fish and Wildlife Service

Abstract: Big Spring Spinedace (Lepidomeda mollispinis pratensis), a small-bodied cyprinid listed as Threatened under the Endangered Species Act since 1985, persists as a single isolated population within roughly 8 km of habitat in Condor Canyon, Meadow Valley Wash, Nevada. Because a single population faces substantial extinction risk from catastrophic events such as drought, disease, or nonnative invasions, establishing refuge populations through translocation is a priority recovery action. We evaluated potential translocation sites across six 500-m reaches, comparing two occupied reaches in Condor Canyon against four candidate reaches in Clover Creek and Rainbow Canyon. We assessed thermal habitat with air and stream temperature loggers recording hourly from March 2024 through February 2025, and we censused pool habitat in spring and fall 2024. Occupied reaches were generally cooler and more thermally variable than potential sites, with evidence of freezing and anchor ice at Lower Condor Canyon that reflects the strong alluvial groundwater influence of the occupied core. The occupied core also supported the greatest number of pools by an order of magnitude and was characterized by silt substrates, in contrast to the sand and cobble dominant at most potential sites, and multivariate analyses indicated significant differences in pool habitat between the occupied core and potential reaches in both seasons. These results indicate that no single potential reach closely matches the thermal and pool habitat conditions of the occupied core, though Clover Creek showed the most promise given its spring-influenced thermal regime. Nonnative species, groundwater decline, and flow intermittency remain key considerations, and critical knowledge gaps around basic life history, food web support, and nonnative interactions will need to be resolved to inform translocation prioritization.
...
<div style="background-color:rgba(0, 0, 0, 0.0470588); padding:0px 12px;">
<a style="color:black">
<font size="4"> **The Influence of Stream Flow Patterns on Juvenile Salmon Foraging and Growth in Southeast Alaska (2021 - in progress)** </font>
</a>
</div>
...
<div style="background-color:rgba(0, 0, 0, 0.0470588); padding:0px 12px;">
<a style="color:black">
<font size="4"> **Juvenile Salmon Growth and Heat Stress (2023 - 2026)** </font>
</a>
</div>
