...
output:
  html_document:
    theme: yeti
pagetitle: "Where Are They Now? | Freshwater Fish Ecology Lab"
---
...
<img src="images/Elizabeth_grayling.jpg" style="width:10%; border:2px solid; margin-right: 20px" align="left">

**Dr. Elizabeth Hinkle** (PhD 2025) Post-fire riverscapes: exploring the ecological and behavioral responses of stream communities to wildfire in boreal streams. Current position: Fisheries Manager, Qawalangin Tribe of Unalaska
...
**Kevin Fitzgerald** (MS 2023) Environmental controls on foraging and growth of juvenile salmonids in a southeast Alaska watershed. Current position: Applied River Sciences
...
### <u>**Staff**</u>
**Mark Kolwyck, Freshwater Fisheries Specialist** (UNR; 2024-2026)

### <u>Student Assistants</u>
**Montana Strozzi, Student Fisheries Lab Assistant** (UNR; 2025-2026)

**Nate Boyd, Student Fisheries Technician** (UNR; 2025-2026)
